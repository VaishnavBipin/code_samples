...
class TestSearch:
    ...
    ## use.
    @pytest.mark.parametrize("alg", ["a_star", "bfs"])
    ...
    @pytest.mark.parametrize("action,player,is_valid,val_msg", [
        ...
        ((5,4), 0, True, ""),
        ((5,5), 0, True, ""),
        ((0,2),0,False,"Cannot move block piece: Block cannot reach location"),
        ((0,-5),0,False,"Cannot move block piece: Position out of bounds"),
        ((5,6), 0, False, "Cannot move ball piece: No player at position"),
        ((1,56), 1, False, "Cannot move block piece: Position out of bounds"),
        ((3,48), 1, True, ""),
        ((0,14), 1, False, "Cannot move block piece: Block cannot reach location")
    ])
    ...
    @pytest.mark.parametrize("state,is_term", [
        ...
        ([-1,-2,-3,-4,-5,5,50,4,52,53,6,6], False), ## Invalid State (player 0 out of bounds)
        ([1,2,3,4,5,5,-50,-4,-52,53,6,6], False), ## Invalid State (player 1 out of bounds)
    ])
    ...
    @pytest.mark.parametrize("state,reachable,player", [
        ...
        (
            [
                (0,0),(3,3),(6,6),(0,7),(1,6),(0,0),
                (4,4),(0,4),(5,0),(5,1),(6,0),(6,0)
            ],
            set([(3,3)]),
            0
        ),
        (
            [
                (0,0),(3,3),(6,6),(0,7),(2,7),(0,0),
                (4,4),(4,0),(5,0),(5,1),(6,0),(6,0)
            ],
            set([(3,3),(0,7),(2,7)]),
            0
        ),
        ...
        (
            [
                (1,2),(5,2),(1,6),(5,6),(3,4),(3,4),
                (3,2),(1,4),(5,4),(3,6),(3,5),(3,5)
            ],
            set([(1,2),(5,2),(1,6),(5,6)]),
            0
        ),
        (
            [
                (1,1),(5,1),(1,6),(5,6),(3,4),(1,1),
                (1,2),(2,1),(2,2),(3,6),(3,5),(3,5)
            ],
            set(),
            0
        )
